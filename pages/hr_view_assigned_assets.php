...
<?php
  session_start();
  require "../php/hr.php";
  $result = view_assets_assigned($conn);
?>
  ...
  <body>
    ...
    <section class="home-section p-6">
      <div class="container">
        <section class="main">
          <div class="main-top">
            <h1 class="font-semibold text-3xl">Assigned Assets</h1>
          ...
          <section class="attendance">
            <div class="attendance-list">
              ...
              <table class="table">
                ...
                <tbody>
                <?php while($assets = mysqli_fetch_assoc($result)){
                    echo "<tr>";
                    echo "<td>" . $assets["department_name"]. "</td>";
                    echo "<td>" . $assets["employee_name"]. "</td>";
                    echo "<td>" . $assets["role"]. "</td>";
